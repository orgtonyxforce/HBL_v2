...
class UsermodExtraOptions : public Usermod
{
...
public:
	UsermodExtraOptions(const char *name, bool enabled) : Usermod(name, enabled) {} // WLEDMM
	...
	//  in setup()
	//   #ifdef USERMOD_EXTRAOPTIONS
	//   UM = (ExtraOptions*) usermods.lookup(USERMOD_ID_EXTRAOPTIONS);
	//   #endif
	...
	*/
	...
	uint16_t getId()
	{
		return USERMOD_ID_EXTRAOPTIONS;
	}
};

const char UsermodExtraOptions::_name[] PROGMEM = "Extraoptions";
